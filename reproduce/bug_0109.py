#!/usr/bin/env python3
"""
bug_0109 — DISCREPANCY bug
============================================================
Compiler class : xla
Affected       : torch_compile, tvm, xla
Total score    : 7.0000
Input shape    : [1, 64, 32, 32]
Patterns       : normalization/manual_layernorm -> normalization/spatial_reduce_mean -> normalization/layernorm_dropout_identity -> normalization/groupnorm_relu -> layout/reshape_layernorm_reshape -> normalization/layernorm_temperature

Bug type: DISCREPANCY

Discrepancy (rel_diff opt vs noopt): {'torch_compile': '1.0000', 'xla': '1.0000', 'tvm': '1.0000'}

Usage:
    python reproduce/bug_0109.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0109.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0109 [DISCREPANCY]")
    print("  patterns : normalization/manual_layernorm -> normalization/spatial_reduce_mean -> normalization/layernorm_dropout_identity -> normalization/groupnorm_relu -> layout/reshape_layernorm_reshape -> normalization/layernorm_temperature")
