#!/usr/bin/env python3
"""
bug_0028 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.0018
Input shape    : [1, 64, 128]
Patterns       : attention/scaled_dot_product_attention -> layout/squeeze_unsqueeze -> layout/squeeze_unsqueeze -> branch/residual_add_relu -> constant/where_const_cond -> layout/squeeze_unsqueeze
...
Usage:
    python reproduce/bug_0028.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0028.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0028 [DISCREPANCY]")
    print("  patterns : attention/scaled_dot_product_attention -> layout/squeeze_unsqueeze -> layout/squeeze_unsqueeze -> branch/residual_add_relu -> constant/where_const_cond -> layout/squeeze_unsqueeze")
