#!/usr/bin/env python3
"""
bug_0148 — DISCREPANCY bug
============================================================
Compiler class : onnxruntime
Affected       : onnxruntime
Total score    : 2.0000
Input shape    : [1, 32, 32, 32]
Patterns       : layout/pad_conv -> branch/conv_branch_add -> normalization/instancenorm_relu -> broadcast/sqrt_div_rms
...
Usage:
    python reproduce/bug_0148.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0148.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0148 [DISCREPANCY]")
    print("  patterns : layout/pad_conv -> branch/conv_branch_add -> normalization/instancenorm_relu -> broadcast/sqrt_div_rms")
