#!/usr/bin/env python3
"""
bug_0024 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 5.0108
Input shape    : [1, 3, 32, 32]
Patterns       : layout/double_transpose -> branch/concat_conv -> broadcast/floor_ceil_round -> broadcast/euclidean_norm_broadcast -> constant/div_by_constant -> normalization/layernorm_relu
...
Usage:
    python reproduce/bug_0024.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0024.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0024 [DISCREPANCY]")
    print("  patterns : layout/double_transpose -> branch/concat_conv -> broadcast/floor_ceil_round -> broadcast/euclidean_norm_broadcast -> constant/div_by_constant -> normalization/layernorm_relu")
