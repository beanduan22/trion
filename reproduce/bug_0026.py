#!/usr/bin/env python3
"""
bug_0026 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.0007
Input shape    : [1, 64, 256]
Patterns       : branch/residual_add_relu -> broadcast/l2_norm -> attention/scaled_dot_product_attention -> branch/add_layernorm -> layout/squeeze_unsqueeze -> layout/squeeze_unsqueeze
...
Usage:
    python reproduce/bug_0026.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0026.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0026 [DISCREPANCY]")
    print("  patterns : branch/residual_add_relu -> broadcast/l2_norm -> attention/scaled_dot_product_attention -> branch/add_layernorm -> layout/squeeze_unsqueeze -> layout/squeeze_unsqueeze")
