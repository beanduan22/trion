#!/usr/bin/env python3
"""
bug_0110 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 4.0000
Input shape    : [1, 128, 32, 32]
Patterns       : broadcast/where_mask -> normalization/groupnorm_relu -> layout/reshape_batched_matmul -> constant/cast_roundtrip -> broadcast/floor_ceil_round -> constant/cast_roundtrip
...
Usage:
    python reproduce/bug_0110.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0110.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0110 [DISCREPANCY]")
    print("  patterns : broadcast/where_mask -> normalization/groupnorm_relu -> layout/reshape_batched_matmul -> constant/cast_roundtrip -> broadcast/floor_ceil_round -> constant/cast_roundtrip")
