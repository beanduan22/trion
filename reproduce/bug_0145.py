#!/usr/bin/env python3
"""
bug_0145 — DISCREPANCY bug
============================================================
Compiler class : onnxruntime
Affected       : onnxruntime
Total score    : 2.0000
Input shape    : [1, 3, 32, 32]
Patterns       : broadcast/exp_div_softplus -> branch/dual_pool_add -> fusion/gap_linear -> fusion/matmul_bias_gelu
...
Usage:
    python reproduce/bug_0145.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0145.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0145 [DISCREPANCY]")
    print("  patterns : broadcast/exp_div_softplus -> branch/dual_pool_add -> fusion/gap_linear -> fusion/matmul_bias_gelu")
