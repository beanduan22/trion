#!/usr/bin/env python3
"""
bug_0086 — DISCREPANCY bug
============================================================
Compiler class : onnxruntime
Affected       : onnxruntime
Total score    : 2.0001
Input shape    : [1, 64, 256]
Patterns       : layout/squeeze_unsqueeze -> attention/transformer_encoder_layer -> attention/kv_cache_attention -> broadcast/floor_ceil_round -> branch/residual_add_relu -> broadcast/sqrt_div_rms
...
Usage:
    python reproduce/bug_0086.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0086.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0086 [DISCREPANCY]")
    print("  patterns : layout/squeeze_unsqueeze -> attention/transformer_encoder_layer -> attention/kv_cache_attention -> broadcast/floor_ceil_round -> branch/residual_add_relu -> broadcast/sqrt_div_rms")
