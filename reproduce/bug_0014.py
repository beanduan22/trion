#!/usr/bin/env python3
"""
bug_0014 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.0017
Input shape    : [1, 16, 128]
Patterns       : attention/causal_masked_attention -> layout/squeeze_unsqueeze -> broadcast/clipped_affine -> broadcast/reciprocal_mul -> layout/squeeze_unsqueeze -> layout/squeeze_unsqueeze
...
Usage:
    python reproduce/bug_0014.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0014.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0014 [DISCREPANCY]")
    print("  patterns : attention/causal_masked_attention -> layout/squeeze_unsqueeze -> broadcast/clipped_affine -> broadcast/reciprocal_mul -> layout/squeeze_unsqueeze -> layout/squeeze_unsqueeze")
