#!/usr/bin/env python3
"""
bug_0001 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.0012
Input shape    : [1, 32, 256]
Patterns       : branch/residual_add_relu -> attention/self_attention_residual -> normalization/variance_whitening -> layout/squeeze_unsqueeze -> layout/squeeze_unsqueeze -> branch/add_layernorm
...
Usage:
    python reproduce/bug_0001.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0001.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0001 [DISCREPANCY]")
    print("  patterns : branch/residual_add_relu -> attention/self_attention_residual -> normalization/variance_whitening -> layout/squeeze_unsqueeze -> layout/squeeze_unsqueeze -> branch/add_layernorm")
