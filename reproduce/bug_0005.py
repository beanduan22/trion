#!/usr/bin/env python3
"""
bug_0005 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.0070
Input shape    : [1, 64, 64]
Patterns       : layout/squeeze_unsqueeze -> normalization/l2_normalize -> layout/squeeze_unsqueeze -> attention/self_attention_residual -> constant/sqrt_reciprocal_mul -> layout/squeeze_unsqueeze
...
Usage:
    python reproduce/bug_0005.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0005.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0005 [DISCREPANCY]")
    print("  patterns : layout/squeeze_unsqueeze -> normalization/l2_normalize -> layout/squeeze_unsqueeze -> attention/self_attention_residual -> constant/sqrt_reciprocal_mul -> layout/squeeze_unsqueeze")
    print("  input    : [1, 64, 64]")
