#!/usr/bin/env python3
"""
bug_0011 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.0026
Input shape    : [1, 64, 256]
Patterns       : layout/squeeze_unsqueeze -> broadcast/clipped_affine -> attention/rotary_embedding_attention -> constant/log_exp_cancel -> branch/residual_add_relu -> broadcast/sub_mul_add
...
Usage:
    python reproduce/bug_0011.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0011.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0011 [DISCREPANCY]")
    print("  patterns : layout/squeeze_unsqueeze -> broadcast/clipped_affine -> attention/rotary_embedding_attention -> constant/log_exp_cancel -> branch/residual_add_relu -> broadcast/sub_mul_add")
