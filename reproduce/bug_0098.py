#!/usr/bin/env python3
"""
bug_0098 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 2.0000
Input shape    : [1, 64, 16, 16]
Patterns       : layout/ceil_mode_avg_pool_conv -> broadcast/l2_norm -> fusion/conv_bn_relu -> branch/dense_residual_block -> fusion/conv_bn_relu -> broadcast/floor_ceil_round
...
Usage:
    python reproduce/bug_0098.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0098.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0098 [DISCREPANCY]")
    print("  patterns : layout/ceil_mode_avg_pool_conv -> broadcast/l2_norm -> fusion/conv_bn_relu -> branch/dense_residual_block -> fusion/conv_bn_relu -> broadcast/floor_ceil_round")
