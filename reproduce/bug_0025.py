#!/usr/bin/env python3
"""
bug_0025 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.0089
Input shape    : [1, 64, 256]
Patterns       : branch/add_layernorm -> normalization/ada_layer_norm -> normalization/variance_whitening -> attention/scaled_dot_product_attention -> layout/squeeze_unsqueeze -> constant/slice_full_range
...
Usage:
    python reproduce/bug_0025.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0025.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0025 [DISCREPANCY]")
    print("  patterns : branch/add_layernorm -> normalization/ada_layer_norm -> normalization/variance_whitening -> attention/scaled_dot_product_attention -> layout/squeeze_unsqueeze -> constant/slice_full_range")
