#!/usr/bin/env python3
"""
bug_0057 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 2.0003
Input shape    : [1, 32, 16, 16]
Patterns       : branch/split_transform_concat -> broadcast/floor_ceil_round -> constant/redundant_reshape -> normalization/l2_normalize -> normalization/batchnorm_eval -> branch/spatial_attention_cbam
...
Usage:
    python reproduce/bug_0057.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0057.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0057 [DISCREPANCY]")
    print("  patterns : branch/split_transform_concat -> broadcast/floor_ceil_round -> constant/redundant_reshape -> normalization/l2_normalize -> normalization/batchnorm_eval -> branch/spatial_attention_cbam")
