#!/usr/bin/env python3
"""
bug_0002 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.0013
Input shape    : [1, 3, 32, 32]
Patterns       : constant/pow_canonical -> broadcast/swish -> broadcast/log_clamp -> constant/log_exp_cancel -> constant/transpose_inverse_cancel -> fusion/conv_bn_relu
...
Usage:
    python reproduce/bug_0002.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0002.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0002 [DISCREPANCY]")
    print("  patterns : constant/pow_canonical -> broadcast/swish -> broadcast/log_clamp -> constant/log_exp_cancel -> constant/transpose_inverse_cancel -> fusion/conv_bn_relu")
