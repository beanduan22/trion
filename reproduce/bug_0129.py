#!/usr/bin/env python3
"""
bug_0129 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 2.0000
Input shape    : [1, 3, 32, 32]
Patterns       : layout/ceil_mode_avg_pool_conv -> broadcast/abs_neg_relu -> broadcast/sub_mul_add -> constant/div_by_constant -> fusion/conv_bn_elu -> broadcast/floor_ceil_round
...
Usage:
    python reproduce/bug_0129.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0129.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0129 [DISCREPANCY]")
    print("  patterns : layout/ceil_mode_avg_pool_conv -> broadcast/abs_neg_relu -> broadcast/sub_mul_add -> constant/div_by_constant -> fusion/conv_bn_elu -> broadcast/floor_ceil_round")
