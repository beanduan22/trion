#!/usr/bin/env python3
"""
bug_0131 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 2.0002
Input shape    : [1, 128, 16, 16]
Patterns       : branch/aspp_dilated_branch -> normalization/batchnorm_relu6 -> normalization/layernorm_temperature -> branch/max_avg_pool_fusion -> broadcast/log_clamp -> broadcast/sub_mul_add
...
Usage:
    python reproduce/bug_0131.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0131.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0131 [DISCREPANCY]")
    print("  patterns : branch/aspp_dilated_branch -> normalization/batchnorm_relu6 -> normalization/layernorm_temperature -> branch/max_avg_pool_fusion -> broadcast/log_clamp -> broadcast/sub_mul_add")
