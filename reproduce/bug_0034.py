#!/usr/bin/env python3
"""
bug_0034 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.0064
Input shape    : [1, 32, 256]
Patterns       : attention/transformer_encoder_layer -> layout/squeeze_unsqueeze -> layout/squeeze_unsqueeze -> broadcast/mul_add_relu -> attention/transformer_ffn -> constant/identity_chain
...
Usage:
    python reproduce/bug_0034.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0034.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0034 [DISCREPANCY]")
    print("  patterns : attention/transformer_encoder_layer -> layout/squeeze_unsqueeze -> layout/squeeze_unsqueeze -> broadcast/mul_add_relu -> attention/transformer_ffn -> constant/identity_chain")
