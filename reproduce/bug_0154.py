#!/usr/bin/env python3
"""
bug_0154 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 2.0007
Input shape    : [1, 32, 32, 32]
Patterns       : constant/mul_by_reciprocal -> fusion/conv_bn_relu6 -> constant/learned_temperature_scale -> layout/pad_conv -> branch/glu -> broadcast/sub_mul_add
...
Usage:
    python reproduce/bug_0154.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0154.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0154 [DISCREPANCY]")
    print("  patterns : constant/mul_by_reciprocal -> fusion/conv_bn_relu6 -> constant/learned_temperature_scale -> layout/pad_conv -> branch/glu -> broadcast/sub_mul_add")
