#!/usr/bin/env python3
"""
bug_0015 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.0040
Input shape    : [1, 256]
Patterns       : constant/sqrt_reciprocal_mul -> fusion/linear_layernorm_gelu -> broadcast/softmax_mul -> normalization/variance_whitening -> fusion/linear_layernorm_gelu -> broadcast/softmax_mul
...
Usage:
    python reproduce/bug_0015.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0015.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0015 [DISCREPANCY]")
    print("  patterns : constant/sqrt_reciprocal_mul -> fusion/linear_layernorm_gelu -> broadcast/softmax_mul -> normalization/variance_whitening -> fusion/linear_layernorm_gelu -> broadcast/softmax_mul")
    print("  input    : [1, 256]")
