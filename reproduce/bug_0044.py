#!/usr/bin/env python3
"""
bug_0044 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 3.0003
Input shape    : [1, 3, 32, 32]
Patterns       : normalization/manual_layernorm -> normalization/spatial_reduce_mean -> layout/reflect_pad_conv -> branch/dual_pool_add -> normalization/l2_normalize -> layout/flatten_unsqueeze_concat
...
Usage:
    python reproduce/bug_0044.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0044.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0044 [DISCREPANCY]")
    print("  patterns : normalization/manual_layernorm -> normalization/spatial_reduce_mean -> layout/reflect_pad_conv -> branch/dual_pool_add -> normalization/l2_normalize -> layout/flatten_unsqueeze_concat")
