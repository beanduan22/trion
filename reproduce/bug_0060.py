#!/usr/bin/env python3
"""
bug_0060 — DISCREPANCY bug
============================================================
Compiler class : onnxruntime
Affected       : onnxruntime, torch_compile, torchscript
Total score    : 6.0000
Input shape    : [1, 3, 32, 32]
Patterns       : broadcast/floor_ceil_round -> branch/spatial_attention_cbam -> normalization/manual_layernorm -> fusion/gap_linear -> fusion/matmul_bias_tanh -> branch/glu
...
Usage:
    python reproduce/bug_0060.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0060.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0060 [DISCREPANCY]")
    print("  patterns : broadcast/floor_ceil_round -> branch/spatial_attention_cbam -> normalization/manual_layernorm -> fusion/gap_linear -> fusion/matmul_bias_tanh -> branch/glu")
