#!/usr/bin/env python3
"""
bug_0137 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 4.0000
Input shape    : [1, 64, 16, 16]
Patterns       : fusion/conv_gelu -> fusion/conv_bn_leakyrelu -> fusion/conv_bn_relu -> normalization/rmsnorm -> constant/pow_canonical -> constant/cast_roundtrip
...
Usage:
    python reproduce/bug_0137.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0137.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0137 [DISCREPANCY]")
    print("  patterns : fusion/conv_gelu -> fusion/conv_bn_leakyrelu -> fusion/conv_bn_relu -> normalization/rmsnorm -> constant/pow_canonical -> constant/cast_roundtrip")
