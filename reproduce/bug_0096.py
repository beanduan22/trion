#!/usr/bin/env python3
"""
bug_0096 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 3.5501
Input shape    : [1, 64, 32, 32]
Patterns       : layout/depth_to_space_block -> branch/max_avg_pool_fusion -> normalization/variance_whitening -> layout/ceil_mode_avg_pool_conv -> broadcast/log_clamp -> broadcast/floor_ceil_round
...
Usage:
    python reproduce/bug_0096.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0096.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0096 [DISCREPANCY]")
    print("  patterns : layout/depth_to_space_block -> branch/max_avg_pool_fusion -> normalization/variance_whitening -> layout/ceil_mode_avg_pool_conv -> broadcast/log_clamp -> broadcast/floor_ceil_round")
