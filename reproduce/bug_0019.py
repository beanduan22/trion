#!/usr/bin/env python3
"""
bug_0019 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.3670
Input shape    : [1, 3, 32, 32]
Patterns       : constant/log_exp_cancel -> normalization/manual_layernorm -> branch/multi_scale_conv_branch -> normalization/spatial_reduce_mean -> fusion/dilated_conv_bn_relu -> constant/slice_full_range
...
Usage:
    python reproduce/bug_0019.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0019.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0019 [DISCREPANCY]")
    print("  patterns : constant/log_exp_cancel -> normalization/manual_layernorm -> branch/multi_scale_conv_branch -> normalization/spatial_reduce_mean -> fusion/dilated_conv_bn_relu -> constant/slice_full_range")
