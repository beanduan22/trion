#!/usr/bin/env python3
"""
bug_0105 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 2.0000
Input shape    : [1, 32, 32, 32]
Patterns       : fusion/conv_asym_pad_bn -> constant/div_by_constant -> fusion/conv_bn_relu -> broadcast/swish -> normalization/batchnorm_eval -> broadcast/floor_ceil_round
...
Usage:
    python reproduce/bug_0105.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0105.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0105 [DISCREPANCY]")
    print("  patterns : fusion/conv_asym_pad_bn -> constant/div_by_constant -> fusion/conv_bn_relu -> broadcast/swish -> normalization/batchnorm_eval -> broadcast/floor_ceil_round")
