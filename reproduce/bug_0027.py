#!/usr/bin/env python3
"""
bug_0027 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.3261
Input shape    : [1, 3, 32, 32]
Patterns       : fusion/conv_bn_elu -> broadcast/l2_norm -> broadcast/hard_clamp_norm -> broadcast/floor_ceil_round -> branch/fpn_branch -> broadcast/cumsum
...
Usage:
    python reproduce/bug_0027.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0027.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0027 [DISCREPANCY]")
    print("  patterns : fusion/conv_bn_elu -> broadcast/l2_norm -> broadcast/hard_clamp_norm -> broadcast/floor_ceil_round -> branch/fpn_branch -> broadcast/cumsum")
