#!/usr/bin/env python3
"""
bug_0012 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.0037
Input shape    : [1, 32, 64]
Patterns       : broadcast/cumsum -> normalization/variance_whitening -> normalization/l2_normalize -> attention/kv_cache_attention -> branch/add_layernorm -> attention/transformer_encoder_layer
...
Usage:
    python reproduce/bug_0012.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0012.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0012 [DISCREPANCY]")
    print("  patterns : broadcast/cumsum -> normalization/variance_whitening -> normalization/l2_normalize -> attention/kv_cache_attention -> branch/add_layernorm -> attention/transformer_encoder_layer")
    print("  input    : [1, 32, 64]")
