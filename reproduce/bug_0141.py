#!/usr/bin/env python3
"""
bug_0141 — DISCREPANCY bug
============================================================
Compiler class : onnxruntime
Affected       : onnxruntime
Total score    : 2.0000
Input shape    : [1, 3, 32, 32]
Patterns       : fusion/depthwise_conv_bn_relu -> broadcast/mul_add_relu -> fusion/conv_bn_relu_maxpool -> branch/conv_branch_add
...
Usage:
    python reproduce/bug_0141.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0141.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0141 [DISCREPANCY]")
    print("  patterns : fusion/depthwise_conv_bn_relu -> broadcast/mul_add_relu -> fusion/conv_bn_relu_maxpool -> branch/conv_branch_add")
