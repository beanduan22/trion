#!/usr/bin/env python3
"""
bug_0037 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 2.0082
Input shape    : [1, 3, 32, 32]
Patterns       : broadcast/hard_clamp_norm -> branch/dense_residual_block -> branch/dense_residual_block -> branch/conv_branch_add -> layout/transpose_conv_nhwc -> normalization/layernorm_relu
...
Usage:
    python reproduce/bug_0037.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0037.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0037 [DISCREPANCY]")
    print("  patterns : broadcast/hard_clamp_norm -> branch/dense_residual_block -> branch/dense_residual_block -> branch/conv_branch_add -> layout/transpose_conv_nhwc -> normalization/layernorm_relu")
