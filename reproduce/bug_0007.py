#!/usr/bin/env python3
"""
bug_0007 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 5.0490
Input shape    : [1, 32, 32, 32]
Patterns       : fusion/dilated_conv_bn_relu -> fusion/conv_bn_silu -> normalization/layernorm_relu -> fusion/conv_bn_silu -> normalization/batchnorm_relu6 -> broadcast/log_clamp
...
Usage:
    python reproduce/bug_0007.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0007.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0007 [DISCREPANCY]")
    print("  patterns : fusion/dilated_conv_bn_relu -> fusion/conv_bn_silu -> normalization/layernorm_relu -> fusion/conv_bn_silu -> normalization/batchnorm_relu6 -> broadcast/log_clamp")
