#!/usr/bin/env python3
"""
bug_0128 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 2.0181
Input shape    : [1, 3, 32, 32]
Patterns       : branch/aspp_dilated_branch -> branch/multi_scale_conv_branch -> constant/sqrt_reciprocal_mul -> broadcast/sqrt_div_rms -> broadcast/swish -> fusion/dilated_conv_bn_relu
...
Usage:
    python reproduce/bug_0128.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0128.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0128 [DISCREPANCY]")
    print("  patterns : branch/aspp_dilated_branch -> branch/multi_scale_conv_branch -> constant/sqrt_reciprocal_mul -> broadcast/sqrt_div_rms -> broadcast/swish -> fusion/dilated_conv_bn_relu")
