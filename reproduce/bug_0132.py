#!/usr/bin/env python3
"""
bug_0132 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 2.0184
Input shape    : [1, 64, 16, 16]
Patterns       : fusion/conv_transpose_bn_relu -> broadcast/floor_ceil_round -> normalization/layernorm_dropout_identity -> normalization/variance_whitening -> broadcast/sqrt_div_rms -> layout/squeeze_unsqueeze
...
Usage:
    python reproduce/bug_0132.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0132.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0132 [DISCREPANCY]")
    print("  patterns : fusion/conv_transpose_bn_relu -> broadcast/floor_ceil_round -> normalization/layernorm_dropout_identity -> normalization/variance_whitening -> broadcast/sqrt_div_rms -> layout/squeeze_unsqueeze")
