#!/usr/bin/env python3
"""
bug_0161 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 0.4813
Input shape    : [1, 128]
Patterns       : layout/gather_reshape -> constant/self_sub_zero -> constant/where_const_cond -> layout/gather_reshape -> fusion/matmul_bias_gelu -> constant/cast_roundtrip
...
Usage:
    python reproduce/bug_0161.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0161.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0161 [DISCREPANCY]")
    print("  patterns : layout/gather_reshape -> constant/self_sub_zero -> constant/where_const_cond -> layout/gather_reshape -> fusion/matmul_bias_gelu -> constant/cast_roundtrip")
    print("  input    : [1, 128]")
