#!/usr/bin/env python3
"""
bug_0143 — DISCREPANCY bug
============================================================
Compiler class : onnxruntime
Affected       : onnxruntime
Total score    : 2.0000
Input shape    : [1, 256]
Patterns       : constant/div_by_constant -> fusion/matmul_bias_gelu -> constant/pow_canonical -> normalization/layernorm_residual_add
...
Usage:
    python reproduce/bug_0143.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0143.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0143 [DISCREPANCY]")
    print("  patterns : constant/div_by_constant -> fusion/matmul_bias_gelu -> constant/pow_canonical -> normalization/layernorm_residual_add")
    print("  input    : [1, 256]")
