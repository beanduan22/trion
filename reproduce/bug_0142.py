#!/usr/bin/env python3
"""
bug_0142 — DISCREPANCY bug
============================================================
Compiler class : onnxruntime
Affected       : onnxruntime
Total score    : 2.0000
Input shape    : [1, 128, 16, 16]
Patterns       : branch/dual_pool_add -> constant/pow_canonical -> normalization/layernorm_residual_add -> broadcast/swish
...
Usage:
    python reproduce/bug_0142.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0142.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0142 [DISCREPANCY]")
    print("  patterns : branch/dual_pool_add -> constant/pow_canonical -> normalization/layernorm_residual_add -> broadcast/swish")
