#!/usr/bin/env python3
"""
bug_0133 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 4.0001
Input shape    : [1, 3, 32, 32]
Patterns       : constant/cast_roundtrip -> branch/residual_add_relu -> broadcast/mul_add_relu -> fusion/conv_transpose_bn_relu -> fusion/conv_asym_pad_bn -> broadcast/where_mask
...
Usage:
    python reproduce/bug_0133.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0133.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0133 [DISCREPANCY]")
    print("  patterns : constant/cast_roundtrip -> branch/residual_add_relu -> broadcast/mul_add_relu -> fusion/conv_transpose_bn_relu -> fusion/conv_asym_pad_bn -> broadcast/where_mask")
