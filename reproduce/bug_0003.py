#!/usr/bin/env python3
"""
bug_0003 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.0025
Input shape    : [1, 32, 64]
Patterns       : branch/add_layernorm -> attention/kv_cache_attention -> branch/glu -> normalization/layernorm_relu -> attention/kv_cache_attention -> layout/squeeze_unsqueeze
...
Usage:
    python reproduce/bug_0003.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0003.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0003 [DISCREPANCY]")
    print("  patterns : branch/add_layernorm -> attention/kv_cache_attention -> branch/glu -> normalization/layernorm_relu -> attention/kv_cache_attention -> layout/squeeze_unsqueeze")
    print("  input    : [1, 32, 64]")
