#!/usr/bin/env python3
"""
bug_0144 — DISCREPANCY bug
============================================================
Compiler class : onnxruntime
Affected       : onnxruntime
Total score    : 2.0000
Input shape    : [1, 3, 32, 32]
Patterns       : constant/cast_roundtrip -> branch/glu -> broadcast/swish -> broadcast/exp_div_softplus
...
Usage:
    python reproduce/bug_0144.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0144.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0144 [DISCREPANCY]")
    print("  patterns : constant/cast_roundtrip -> branch/glu -> broadcast/swish -> broadcast/exp_div_softplus")
