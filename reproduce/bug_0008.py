#!/usr/bin/env python3
"""
bug_0008 — DISCREPANCY bug
============================================================
Compiler class : tflite
Affected       : openvino, tflite
Total score    : 4.0037
Input shape    : [1, 128]
Patterns       : constant/where_const_cond -> constant/identity_chain -> normalization/layernorm_relu -> fusion/matmul_bias_tanh -> fusion/linear_layernorm_gelu -> normalization/variance_whitening
...
Usage:
    python reproduce/bug_0008.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0008.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0008 [DISCREPANCY]")
    print("  patterns : constant/where_const_cond -> constant/identity_chain -> normalization/layernorm_relu -> fusion/matmul_bias_tanh -> fusion/linear_layernorm_gelu -> normalization/variance_whitening")
    print("  input    : [1, 128]")
