#!/usr/bin/env python3
"""
bug_0090 — DISCREPANCY bug
============================================================
Compiler class : torch_compile
Affected       : torch_compile
Total score    : 2.0004
Input shape    : [1, 128]
Patterns       : constant/cast_roundtrip -> broadcast/log_clamp -> branch/add_layernorm -> constant/sqrt_reciprocal_mul -> fusion/matmul_bias_tanh -> branch/add_layernorm
...
Usage:
    python reproduce/bug_0090.py
"""
import os, sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

ONNX_PATH = os.path.join(os.path.dirname(__file__), "..", "bugs", "bug_0090.onnx")
...
if __name__ == "__main__":
    print("Reproducing bug_0090 [DISCREPANCY]")
    print("  patterns : constant/cast_roundtrip -> broadcast/log_clamp -> branch/add_layernorm -> constant/sqrt_reciprocal_mul -> fusion/matmul_bias_tanh -> branch/add_layernorm")
    print("  input    : [1, 128]")
