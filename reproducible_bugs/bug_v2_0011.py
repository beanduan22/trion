#!/usr/bin/env python3
"""
Bug v2-0011 — TF XLA resize_linear_aligncorners + reshape_transpose5d + manual L2 norm
Compiler  : XLA / JAX GPU JIT (GPU-only trigger)
Root cause: JAX linear resize diverges under GPU JIT — JIT uses different
            half_pixel coordinate formula than eager, amplified by manual L2 norm.
            On CPU-only JAX, jit≈eager; divergence requires cuda-jaxlib.
            We reproduce with ORT by comparing linear Resize output vs reference.
"""
import numpy as np
import onnx
