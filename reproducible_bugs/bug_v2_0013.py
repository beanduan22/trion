#!/usr/bin/env python3
"""
Bug v2-0013 — TF XLA resize_linear_aligncorners + reduce_broadcast_norm + group_norm
...
Root cause: JAX linear resize with align_corners gets fused with group norm under
            GPU JIT, introducing different numerical rounding vs eager.
            We reproduce using ORT with asymmetric linear Resize + GroupNorm-equivalent
            (manual ReduceMean/variance/normalize per group).
"""
import numpy as np
import onnx
