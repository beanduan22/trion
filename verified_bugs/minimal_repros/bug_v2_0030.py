#!/usr/bin/env python3
"""
Minimal repro for bug v2-0030 (uid=0030).
...
Root-cause note: original bug compares ORT vs pytorch_eager (onnx2torch); ORT and numpy agree.
                 The divergence from pytorch_eager may be an onnx2torch reference error.
"""
import numpy as np
import onnx
