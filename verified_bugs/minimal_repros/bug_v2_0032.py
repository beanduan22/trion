#!/usr/bin/env python3
"""
Minimal repro for bug v2-0032 (uid=0032).
Compiler  : OnnxRuntime
Patterns  : mul_by_zero skip + double-shift + LayerNorm + matmul+bias + dropout + squeeze/unsqueeze + pow_by_one
Bug desc  : SkipLayerNorm fusion may incorrectly eliminate x*0 skip input.
Oracle    : ORT_ENABLE_ALL vs ORT_DISABLE_ALL and numpy reference.
Note      : Original bug diverges from pytorch_eager. ORT_ENABLE_ALL == ORT_DISABLE_ALL.
"""
import numpy as np
import onnx
