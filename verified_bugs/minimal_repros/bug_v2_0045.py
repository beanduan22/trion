#!/usr/bin/env python3
"""
Bug v2-0045 — TF XLA: resize_cubic_halfpixel + Inception branch + stable-softmax
Compiler : TF XLA (jax.jit on GPU)
Pattern  : resize_cubic_halfpixel after stable-softmax and crms_norm
Root cause: JAX GPU JIT bicubic halfpixel resize diverges from eager after
            stable softmax and CRMSNorm normalization in an Inception-like branch.
