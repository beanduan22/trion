#!/usr/bin/env python3
"""
Bug v2-0043 — TF XLA: resize_linear_aligncorners + FPN branch + batchnorm_momentum
Compiler : TF XLA (jax.jit on GPU)
Pattern  : resize_linear_halfpixel (half_pixel coordinate mode in ONNX)
Root cause: JAX GPU JIT bicubic/linear half_pixel resize diverges from eager —
            coordinate computation uses different float path on GPU.
