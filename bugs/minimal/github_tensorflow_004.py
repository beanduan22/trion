#!/usr/bin/env python3
"""
Bug ID     : github_tensorflow_004
Source     : GitHub — TensorFlow XLA JIT
Compiler   : TensorFlow XLA JIT
Patterns   : conv bn folding quantization
Root cause : Bug: TF BN folding into Conv applied scale incorrectly in quantization-aware training (issue #43882).
Tolerance  : 0.01
