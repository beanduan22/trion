#!/usr/bin/env python3
"""
Bug ID     : github_tvm_006
Source     : GitHub — TVM Relay
Compiler   : TVM Relay
Patterns   : prelu nchw broadcast
Root cause : Bug: TVM PR #7208 — PReLU hardcoded channel axis=1 (NCHW); NHWC slope broadcast applied to H not C.
Tolerance  : 0.01
