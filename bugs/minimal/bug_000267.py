...
Patterns   : MatMul, Add, Sigmoid, Add, Mul, Add, Tanh, Erf...
Root cause : onnxruntime rel_L2=0.972
Minimal ops: MatMul -> Add -> Sigmoid -> Add -> Mul -> Add -> Tanh -> Erf -> Mul -> CumSum (10 ops, down from 12)
Tolerance  : 0.1
...
def build_model() -> bytes:
    ...
    g = helper.make_graph(_nodes(), "bug_000267_min", inputs_info, outputs_info, initializer=_inits())
