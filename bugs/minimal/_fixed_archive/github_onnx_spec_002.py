#!/usr/bin/env python3
"""
Bug ID     : github_onnx_spec_002
Source     : GitHub — ONNX Spec
Compiler   : ONNX Spec
Patterns   : resize output dim floor vs round
Root cause : Bug: ONNX spec #4919 — Resize output dim floor vs round inconsistency; 7*1.5=10.5, ORT uses floor=10.
Tolerance  : 0.01
