#!/usr/bin/env python3
"""
Bug ID     : github_openvino_006
Source     : GitHub — OpenVINO
Compiler   : OpenVINO
Patterns   : resize nearest concat buffer
Root cause : OpenVINO Bug #5505 - Wrong output in Concat->Resize->Concat (in-place buffer reuse)
Tolerance  : 0.01
