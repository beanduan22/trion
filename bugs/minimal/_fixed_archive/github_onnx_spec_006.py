#!/usr/bin/env python3
"""
Bug ID     : github_onnx_spec_006
Source     : GitHub — ONNX Spec
Compiler   : ONNX Spec
Patterns   : cumsum axis optional schema
Root cause : Bug: ONNX spec #2611 — CumSum axis marked optional in schema; absent axis causes undefined behavior.
Tolerance  : 0.01
