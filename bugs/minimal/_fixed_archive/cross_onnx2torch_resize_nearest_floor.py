#!/usr/bin/env python3
"""
Bug ID     : cross_onnx2torch_resize_nearest_floor
Source     : Cross-compiler testing (2026-04-13)
Compiler   : onnx2torch / torch.compile
Patterns   : Resize(nearest, floor, half_pixel, scale 2x)
Root cause : onnx2torch maps ONNX nearest floor+half_pixel to PyTorch asymmetric mode instead of half_pixel; pixel selection diverges with max_diff=4.79 vs ORT reference.
Tolerance  : 0.1
...
print(f"max_diff={diff:.6f}  tol=0.1")
