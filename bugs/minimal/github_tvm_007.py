#!/usr/bin/env python3
"""
Bug ID     : github_tvm_007
Source     : GitHub — TVM Relay
Compiler   : TVM Relay
Patterns   : convtranspose output padding
Root cause : Bug: TVM PR #7958 — ConvTranspose ignores output_padding; stride=2 + output_padding=[1,1] gave 9x9 not 10x10.
Tolerance  : 0.01
