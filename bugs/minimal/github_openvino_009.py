#!/usr/bin/env python3
"""
Bug ID     : github_openvino_009
Source     : GitHub — OpenVINO
Compiler   : OpenVINO
Patterns   : sdpa scale wrong position
Root cause : OpenVINO Bug #34177 - SDPA decomposition applies scale before MatMul(Q,K^T) instead of after
Tolerance  : 0.01
