#!/usr/bin/env python3
"""
Bug ID     : github_ort_018
Source     : GitHub — OnnxRuntime
Compiler   : OnnxRuntime
Patterns   : scatternd duplicate indices
Root cause : Bug: ORT JSEP ScatterND race with duplicate indices (PR#23755). CPU is deterministic (last-write wins).
Tolerance  : 0.01
