...
Patterns   : Transpose, Transpose, MatMul, Transpose, Transpose, Einsum, Mul, ReduceMean...
Root cause : onnxruntime rel_L2=1.251
Minimal ops: Transpose -> Transpose -> MatMul -> Transpose -> Transpose -> Einsum -> Mul -> ReduceMean -> Add -> Pow -> Div -> Mul -> Transpose -> Transpose -> MatMul -> Transpose -> Transpose -> CumSum (18 ops, down from 18)
Tolerance  : 0.1
...
def build_model() -> bytes:
    ...
    g = helper.make_graph(_nodes(), "bug_000248_min", inputs_info, outputs_info, initializer=_inits())
