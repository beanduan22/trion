#!/usr/bin/env python3
"""
Bug ID     : cross_openvino_broadcast_1d_scalar
Compiler   : OpenVINO CPU
Oracle     : ORT_DISABLE_ALL
Patterns   : MatMul(x, W) -> Add(1d_scalar_broadcast_bias)
Root cause : OV CPU GEMM fp32 accumulation differs from ORT with 1D bias broadcast.
Tolerance  : 0.01
...
if max_abs > 0.01:
    print(f"BUG REPRODUCED: OpenVINO broadcast_1d_scalar (max_abs={max_abs:.4f})")
    sys.exit(0)
