...
Bugs #1-3, #5, and #8 are **newly discovered** by cross-compiler testing — taking ONNX patterns that were fixed in one compiler and testing them on other compilers.
